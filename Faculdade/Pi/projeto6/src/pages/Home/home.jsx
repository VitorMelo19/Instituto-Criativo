...
import lucy_crianca from '../../assets/imagens/foto_lucy-p-500.jpeg';
...
import logo_univesp from '../../assets/imagens/parceiros/logo_univesp.jfif';
import logo_sebrae from '../../assets/imagens/parceiros/logo_sebrae.png';
import logo_esmusp from '../../assets/imagens/parceiros/logo_esmusp.jfif';
import logo_fatecmogi from '../../assets/imagens/parceiros/logo_fatecmogi.jfif';
import depoimento1 from '../../assets/imagens/maria.jpg';
import depoimento2 from '../../assets/imagens/carlos.jpg';
import curso1 from '../../assets/imagens/curso1.avif';
import curso2 from '../../assets/imagens/curso2.avif';
import curso3 from '../../assets/imagens/curso3.avif';
import vice_presidente from '../../assets/imagens/vice-presidente.avif';
...
import missao from "../../assets/imagens/icons/alvo.svg";
import visao from "../../assets/imagens/icons/visão.svg";
import valores from "../../assets/imagens/icons/valores.svg";
import aprendizado from "../../assets/imagens/icons/Aprendizado.svg";
import primeiro_emprego from "../../assets/imagens/icons/emprego.svg";
import recolocacao from "../../assets/imagens/icons/Realocação.svg";
import bem_estar from "../../assets/imagens/icons/bem-estar.svg";
import gratuito from "../../assets/imagens/icons/gratuito.svg";
import certificado from "../../assets/imagens/icons/certificado.svg";
import endereço from "../../assets/imagens/icons/endereço.svg";
import telefone from "../../assets/imagens/icons/telefone.svg";
import email from "../../assets/imagens/icons/e-mail.svg";
import horario from "../../assets/imagens/icons/horario.svg";
import facebook from "../../assets/imagens/icons/facebook.svg";
import twitter from "../../assets/imagens/icons/twitter.svg";
import instagram from "../../assets/imagens/icons/instagram.svg";
import linkedin from "../../assets/imagens/icons/linkedin.svg";
import youtube from "../../assets/imagens/icons/youtube.svg";
    ...
    <>
          ...
          <div className="header-content">
            ...
            <nav className="desktop-nav">
              ...
              <div className="nav-buttons">
                ...
                <a href="/login" className="btn btn-outline">Acessar Portal</a>
              </div>
            </nav>
      ...
      <main>
        ...
        <div className="hero-slider">
           <div className={`slide ${currentSlide === 0 ? 'active' : ''}`} style={{ backgroundImage: `url(${arte1})` }}>
            ...
            <div className={`slide ${currentSlide === 1 ? 'active' : ''}`} style={{ backgroundImage: `url(${arte2})` }}>
                <div className="overlay"></div>
                <div className="container">
                    <div className="hero-content">
            ...
            <div className="segments-grid">
                <div className="segment-card">
                    <div className="segment-icon">
                        <img src={aprendizado} alt="aprendizado"/>
                    </div>
                    <h3>Aprendizado</h3>
                ...
                <div className="segment-card">
                    <div className="segment-icon">
                        <img src={primeiro_emprego} alt="primeiro-emprego"/> 
                    </div>
                ...
                <div className="segment-card">
                    <div className="segment-icon">
                        <img src={recolocacao} alt="reacoloação"/> 
                    </div>
                    <h3>Recolocação</h3>
                ...
                <div className="segment-card">
                    <div className="segment-icon">
                        <img src={bem_estar} alt="bem-estar"/> 
                    </div>
                    <h3>Bem-Estar</h3>
        ...
        <div className="container">
            ...
            <div className="benefits-section">
                ...
                <div className="benefits-grid">
                    ...
                    <div className="benefit-card">
                        <div className="benefit-icon">
                            <img src={primeiro_emprego} alt="carreira"/> 
                        </div>
                        <h4>Carreira</h4>
