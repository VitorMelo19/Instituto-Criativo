...
export default function ConfigProf() {
  return (
     <div className="adminDashboard">
            ...
            <section className="card bloco-conta">
                ...
                <div className="botoes-conta">
                    <a href="/dados-prof" className="btn btn-outline">Alterar Dados Pessoais</a>
                    <a href="/email-senha-prof" className="btn btn-outline">Alterar E-mail/Senha</a>
                </div>
